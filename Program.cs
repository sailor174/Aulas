            ...
            while (true)
            {
                ...
                if (tarefa == "adicionar" || tarefa == "1")
                {
                    ...
                    if (adicionar == "Óleo" || adicionar == "1" || adicionar == "oleo")
                    {
                        ...
                        Óleo[2] += AlterarQntdProdutos(1, Console.ReadLine());
                    ...
                    {
                        Console.Write("Quantidade: ");
                        Farinha[2] += AlterarQntdProdutos(1, Console.ReadLine());
                    ...
                    {
                        Console.Write("Quantidade: ");
                        DuziaDeOvos[2] += AlterarQntdProdutos(1, Console.ReadLine());
                    ...
                    {
                        Console.Write("Quantidade: ");
                        Carne[2] += AlterarQntdProdutos(1, Console.ReadLine());
